...
<div class="events-section__card  events-section__card-medium--archive-exhibition">

<div class="row__12">
  
  <div class="events-section__date-and-text">
  <a class="page-links" href="<?php the_permalink(); ?>"><h2 class="events-section__section-title events-section__section-title--archive-exhibition custom-underline"><?php the_title(); ?></h2></a>
